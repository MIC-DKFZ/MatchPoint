...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/IO/include/mapNullRegistrationKernelWriter.h $
*/
...
namespace map
{
	namespace io
	{
		...
		*/
		...
		class NullRegistrationKernelWriter : public RegistrationKernelWriterBase<VInputDimensions, VOutputDimensions>
		{
		public:
