...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/IO/include/mapExpandingFieldKernelWriter.h $
*/
...
namespace map
{
	namespace io
	{
		...
		*/
		...
		class ExpandingFieldKernelWriter : public RegistrationKernelWriterBase<VInputDimensions, VOutputDimensions>
		{
		public:
