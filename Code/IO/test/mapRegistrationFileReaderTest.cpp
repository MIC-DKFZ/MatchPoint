...
namespace map
{
	namespace testing
	{
      ...
      CHECK(NULL != LoaderStackType::getProvider(io::ExpandingFieldKernelLoader<2, 2>::getStaticProviderName()));
      CHECK(NULL != LoaderStackType::getProvider(io::ExpandingFieldKernelLoader<3, 3>::getStaticProviderName()));
