...
// Subversion HeadURL: $HeadURL: https://svn/sbr/Sources/SBR-Projects/MatchPoint/trunk/Code/IO/test/mapFieldKernelLoaderTest.cpp $
*/
...
namespace map
{
	namespace testing
	{
		...
		int mapFieldKernelLoaderTest(int argc, char* argv[])
		{
			...
			CHECK_EQUAL("FieldKernelLoader<2,2>", spLoader->getProviderName());
			CHECK_EQUAL("FieldKernelLoader<2,3>", Loader23Type::getStaticProviderName());
