...
// Subversion HeadURL: $HeadURL: https://svn/sbr/Sources/SBR-Projects/MatchPoint/trunk/Code/IO/test/mapInvertingFieldKernelWriterTest.cpp $
*/
...
namespace map
{
	namespace testing
	{
      ...
      spInvertingKernel_missingSource->setFieldFunctor(*spFunctor);
			...
			WriterType::RequestType illegalRequest_invalidKernelConfig(spInvertingKernel_missingSource, "", "", false, spSourceKernel);
      ...
      WriterType::RequestType illegalRequest_expandLazy(spInvertingKernel, "", "", true, spSourceKernel);
			WriterType::RequestType request(spInvertingKernel, testPath, "InvertingFieldKernelWriterTest", false, spSourceKernel);
      ...
      CHECK_EQUAL(false, spWriter->canHandleRequest(illegalRequest_expandLazy));
			...
			CHECK_THROW_EXPLICIT(spWriter->storeKernel(illegalRequest_invalidKernelType), core::ServiceException);
      CHECK_THROW_EXPLICIT(spWriter->storeKernel(illegalRequest_invalidKernelConfig), core::ServiceException);
