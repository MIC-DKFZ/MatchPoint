...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Deployment/test/mapTestAlgorithmInvalid5DLL.cpp $
*/

/*! @file
 * invalid test dll that returns no valid UID when calling mapGetRegistrationAlgorithmUID.
 */
...
mapGenerateAlgorithmUIDPolicyMacro(InvalidTestAlgUIDPolicy,"de.dkfz.matchpoint.test", "InvalidAlgorithm5_invalidUID", "1.0", "InvalidAlgorithm5_invalidUID");
