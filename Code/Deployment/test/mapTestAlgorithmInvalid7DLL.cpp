...
mapGenerateAlgorithmUIDPolicyMacro(InvalidTestAlgUIDPolicy, "de.dkfz.matchpoint.test",
								   "InvalidAlgorithm7_missingSymbol", "1.0", "InvalidAlgorithm7_missingSymbol");
...
{
	spUID = map::algorithm::UID::New("de.dkfz.matchpoint.test", "InvalidAlgorithm7_missingSymbol",
									 "1.0", "");
};
