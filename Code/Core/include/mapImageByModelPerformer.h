...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Core/include/mapImageByModelPerformer.h $
*/
...
namespace map
{
	namespace core
	{
		...
		*/
		...
		class ImageByModelPerformer : public ImageMappingPerformerBase<TRegistration, TInputData, TResultData>
		{
		public:
