...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Core/include/mapFieldModelKernelCombinator.tpp $
*/
...
namespace map
{
	namespace core
	{
		               ...
		               const PaddingVectorType &paddingVector) const
		{
			...
			typedef typename functors::FieldByFieldModelCombinationFunctor<VInputDimensions, VInterimDimensions, VOutputDimensions> FunctorType;
		...
		{
			OStringStream os;
			os << "FieldModelKernelCombinator<" << VInputDimensions << "," << VInterimDimensions << "," << VOutputDimensions << ">";
			return os.str();
		}
		...
		{
			OStringStream os;
			os << "FieldModelKernelCombinator, VInputDimensions: " << VInputDimensions << ", VInterimDimensions: " << VInterimDimensions << ", VOutputDimensions: " << VOutputDimensions << ".";
			return os.str();
		}
