...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Core/include/mapSyncObject.h $
*/
...
namespace map
{
	namespace deployment
	{
		...
		public:
			...
			template<typename TPropReturnType> bool getProperty(SyncPropertyTagType tag, TPropReturnType &prop) const
			{
				bool result = false;
