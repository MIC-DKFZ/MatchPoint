...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Core/include/mapModelFieldKernelCombinator.h $
*/
...
namespace map
{
	namespace core
	{
		...
		*/
		...
		class ModelFieldKernelCombinator : public RegistrationKernelCombinatorBase< VInputDimensions, VInterimDimensions, VOutputDimensions >
		{
		public:
