...
#ifndef __ITK_UNARY_TRANSFORM_MODEL_H
#define __ITK_UNARY_TRANSFORM_MODEL_H
...
namespace map
{
	namespace core
	{
		...
		* only one dimension template variable (the typical transform e.g. itk::ScaleTransform)
		...
		*/
		...
		class ITKUnaryTransformModel : public TransformModelBase<TScalarType, VDimensions, VDimensions>
		{
		public:
			/*! Standard class typedefs. */
			typedef ITKUnaryTransformModel<TTransform, TScalarType, VDimensions>  Self;
			typedef TransformModelBase<TScalarType, VDimensions, VDimensions>  Superclass;
			typedef itk::SmartPointer<Self>        Pointer;
			typedef itk::SmartPointer<const Self>  ConstPointer;

			itkTypeMacro(ITKUnaryTransformModel, TransformModelBase);
			...
			typedef Self                                                  InverseTransformModelType;
			...
			typedef TTransform<TScalarType, VDimensions>                   TransformType;
