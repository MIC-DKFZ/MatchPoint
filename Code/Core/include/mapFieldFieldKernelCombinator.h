...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Core/include/mapFieldFieldKernelCombinator.h $
*/

#ifndef __MAP_FIELD_FIELD_KERNEL_COMBINATOR_H
#define __MAP_FIELD_FIELD_KERNEL_COMBINATOR_H
...
namespace map
{
	namespace core
	{
		/*! @class FieldFieldKernelCombinator
		...
		*/
		...
		class FieldFieldKernelCombinator : public RegistrationKernelCombinatorBase< VInputDimensions, VInterimDimensions, VOutputDimensions >
		{
		public:
			/*! Standard class typedefs. */
			typedef FieldFieldKernelCombinator< VInputDimensions, VInterimDimensions, VOutputDimensions >  Self;
			...
			itkTypeMacro(FieldFieldKernelCombinator, RegistrationKernelCombinatorBase);
			itkNewMacro(Self);
		...
		protected:
			...
			virtual ~FieldFieldKernelCombinator() {};

		private:
			FieldFieldKernelCombinator(const Self &); //purposely not implemented
