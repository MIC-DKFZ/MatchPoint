...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Core/include/mapFieldByModelFieldCombinationFunctor.h $
*/
	...
	namespace core
	{
		namespace functors
		{
			...
			*/
			...
			class FieldByModelFieldCombinationFunctor: public FieldGenerationFunctor<VInputDimensions, VOutputDimensions>,
				public FieldCombinationFunctorInterface<VInputDimensions, VInterimDimensions, VOutputDimensions>
			{
			public:
				/*! Standard class typedefs. */
				typedef FieldByModelFieldCombinationFunctor<VInputDimensions, VInterimDimensions, VOutputDimensions>  Self;
