...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Core/include/mapRegistration.tpp $
*/
...
namespace map
{
	namespace core
	{
		...
		template < unsigned int VMovingDimensions, unsigned int VTargetDimensions,
		         template <unsigned int, unsigned int> class TRegistrationTopologyPolicy >
		const typename Registration<VMovingDimensions, VTargetDimensions, TRegistrationTopologyPolicy>::InverseMappingType &
		Registration<VMovingDimensions, VTargetDimensions, TRegistrationTopologyPolicy>::
		...
		template < unsigned int VMovingDimensions, unsigned int VTargetDimensions,
		         template <unsigned int, unsigned int> class TRegistrationTopologyPolicy >
		const typename Registration<VMovingDimensions, VTargetDimensions, TRegistrationTopologyPolicy>::DirectMappingType &
		Registration<VMovingDimensions, VTargetDimensions, TRegistrationTopologyPolicy>::
