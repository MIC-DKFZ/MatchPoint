...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Core/include/mapNullRegistrationKernelCombinator.h $
*/


#ifndef __MAP_NULL_REGISTRATION_KERNEL_COMBINATOR_H
#define __MAP_NULL_REGISTRATION_KERNEL_COMBINATOR_H
...
namespace map
{
	namespace core
	{
		...
		*/
		...
		class NullRegistrationKernelCombinator : public RegistrationKernelCombinatorBase< VInputDimensions, VInterimDimensions, VOutputDimensions >
		{
		public:
			/*! Standard class typedefs. */
			typedef NullRegistrationKernelCombinator< VInputDimensions, VInterimDimensions, VOutputDimensions >  Self;
			...
			typedef NullRegistrationKernel<VInterimDimensions, VOutputDimensions>  Kernel2Type;

			itkTypeMacro(NullRegistrationKernelCombinator, RegistrationKernelCombinatorBase);
			itkNewMacro(Self);
