...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Core/include/mapFastLockedThreadingStaticPolicy.h $
*/
		...
		namespace services
		{
			...
			*/
			...
			private:
				...
				FastLockedThreadingStaticPolicy(const FastLockedThreadingStaticPolicy &); //purposely not implemented
