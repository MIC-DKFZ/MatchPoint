...
#ifndef __MAP_POINT_SET_BY_FIELD_PERFORMER_H
#define __MAP_POINT_SET_BY_FIELD_PERFORMER_H
...
namespace map
{
	namespace core
	{
		/*! @class PointSetByFieldPerformer
		* @brief Performer class that maps point data by using a field kernel.
		*
		* @ingroup MappingTask
		...
		*/
		...
		public:
			...
			typedef PointSetByFieldPerformer<TRegistration, TInputData, TResultData>  Self;
			typedef MappingPerformerBase<RequestType>                       Superclass;
			typedef itk::SmartPointer<Self>        Pointer;
			typedef itk::SmartPointer<const Self>  ConstPointer;

			itkTypeMacro(PointSetByFieldPerformer, MappingPerformerBase);
			itkNewMacro(Self);
