...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Core/test/mapStaticServiceStackTest.cpp $
*/
...
namespace map
{
	namespace testing
	{
		...
		typedef core::services::ServiceStack<TestServiceProviderBase, TestLoadPolicy> ConcreteTestServiceStackType;
