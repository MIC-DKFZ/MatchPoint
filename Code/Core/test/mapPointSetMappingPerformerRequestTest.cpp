...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Core/test/mapPointSetMappingPerformerRequestTest.cpp $
*/
...
namespace map
{
	namespace testing
	{
		int mapPointSetMappingPerformerRequestTest(int, char* [])
		{
			...
			typedef core::PointSetMappingPerformerRequest<RegistrationType, InputPointSetType, InputPointSetType> RequestType;
