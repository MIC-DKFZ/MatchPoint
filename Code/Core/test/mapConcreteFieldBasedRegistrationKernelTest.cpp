...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Core/test/mapConcreteFieldBasedRegistrationKernelTest.cpp $
*/
...
namespace map
{
	namespace testing
	{
		...
		int mapConcreteFieldBasedRegistrationKernelTest(int, char* [])
		{
			...
			KernelType::MappingVectorType defaultNullVector(::itk::NumericTraits<KernelType::MappingVectorType::ValueType>::NonpositiveMin());
