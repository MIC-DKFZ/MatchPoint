...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/ITK/test/mapIterativeInverseTransformToDisplacementFieldSourceTest.cpp $
*/
...
namespace map
{
	namespace testing
	{
		...
		int mapIterativeInverseTransformToDisplacementFieldSourceTest(int argc, char *argv[])
		{
			...
			typedef itk::map::IterativeInverseTransformToDisplacementFieldSource<VectorFieldType, core::continuous::ScalarType> FieldSourceType;
