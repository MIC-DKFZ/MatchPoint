//This is a legacy class of itk 4.13
//The class was deprecated in itk 5+ without replacement
//MatchPoint uses the function in its FieldRepresentationDescriptor class.
//for easier migration we conserved the legacy class in the MAPITK
//module until we can also deprecate it.
