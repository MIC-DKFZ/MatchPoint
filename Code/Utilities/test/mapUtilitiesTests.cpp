...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Utilities/test/mapUtilitiesTests.cpp $
*/
...
namespace map
{
	namespace testing
	{
		...
		void registerTests()
		{
			LIT_REGISTER_TEST(mapProcessExecutorTest);
		}
