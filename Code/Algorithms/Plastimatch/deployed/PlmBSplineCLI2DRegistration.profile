...
SET(ALGORITHM_PROFILE_Description "This is a MatchPoint wrapper for the registration tool Plastimatch for 2D images. It is configured to preform a B-Spline registration on the image.")
