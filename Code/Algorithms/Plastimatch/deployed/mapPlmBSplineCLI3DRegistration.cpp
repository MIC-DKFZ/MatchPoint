...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/Plastimatch/deployed/mapPlmBSplineCLI3DRegistration.cpp $
*/
...
mapGenerateAlgorithmUIDPolicyMacro(PlmBSplineCLI3DUIDPolicy, "de.dkfz.matchpoint.plastimatch.cli", "BSplineRegistration.3D", "1.0.0");

typedef map::core::discrete::Elements<3>::InternalImageType ImageType;
typedef map::algorithm::boxed::PlmBSplineCLIRegistrationAlgorithm<ImageType, ImageType, PlmBSplineCLI3DUIDPolicy> AlgorithmType;

typedef map::deployment::DeploymentDLLHelper<AlgorithmType> DLLHelperType;

/** @class PlmBSplineCLI3DImageRegistrationAlgorithm
 * @ingroup Data_image Dim_3D_3D Det_res_multi Model_non_linear_ Mod_multi PreInit_
 */
