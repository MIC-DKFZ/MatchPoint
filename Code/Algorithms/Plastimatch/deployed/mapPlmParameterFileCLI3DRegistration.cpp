...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/Plastimatch/deployed/mapPlmParameterFileCLI3DRegistration.cpp $
*/
...
mapGenerateAlgorithmUIDPolicyMacro(PlmParamFileCLI3DUIDPolicy, "de.dkfz.matchpoint.plastimatch.cli", "ParameterFileRegistration.3D", "1.0.0");

typedef map::core::discrete::Elements<3>::InternalImageType ImageType;
typedef map::algorithm::plastimatch::ParameterFileRegistrationAlgorithm<ImageType, ImageType, PlmParamFileCLI3DUIDPolicy> AlgorithmType;

typedef map::deployment::DeploymentDLLHelper<AlgorithmType> DLLHelperType;

/** @class FSL3DImageRegistrationAlgorithm
 * @ingroup Data_image  Dim_3D3D
 */
