...
typedef map::algorithm::plastimatch::ParameterFileRegistrationAlgorithm<ImageType, ImageType, PointSetType, PointSetType, map::algorithm::PlmParameterFileCLI3DRegistrationUIDPolicy>
AlgorithmType;
