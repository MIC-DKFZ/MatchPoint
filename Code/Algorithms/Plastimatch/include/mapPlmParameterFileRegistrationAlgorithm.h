...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/Plastimatch/include/mapPlmParameterFileRegistrationAlgorithm.h $
*/




#ifndef __MAP_PLM_PARAMETERFILE_REGISTRATION_ALGORITHM_H
#define __MAP_PLM_PARAMETERFILE_REGISTRATION_ALGORITHM_H
...
namespace map
{
	namespace algorithm
	{
		namespace plastimatch
		{
			...
			mapGenerateAlgorithmUIDPolicyMacro(DefaultPlmParameterFileRegistrationUIDPolicy, "de.dkfz.matchpoint.plastimatch.cli", "ParameterFileRegistration.Default", "1.0.0");

			/*! @class ParameterFileRegistrationAlgorithm
						@brief The class is an algorithm that serves as a wrapper for the registration tool "plastimatch".
						The algorithm uses user specified parameter files to configure plastimatch. The user can specify the location
						of the parameter files before starting the registration algorithm.
			    @ingroup Algorithms
						@ingroup Plastimatch
			 */
			template<class TMovingImage, class TTargetImage, class TIdentificationPolicy = DefaultPlmParameterFileRegistrationUIDPolicy>
			...
			protected:
				...
				/*! This method is the slot for the generation of the parameter maps that should be passed to plastimatch. The base class assumes that
