...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/Elastix/deployed/mapElxParameterFileCLI3DRegistration.cpp $
*/
...
mapGenerateAlgorithmUIDPolicyMacro(ElxParamFileCLI3DUIDPolicy, "de.dkfz.matchpoint.elastix.cli", "ParameterFileRegistration.3D", "1.0.0");

typedef map::core::discrete::Elements<3>::InternalImageType ImageType;
typedef map::algorithm::elastix::ParameterFileRegistrationAlgorithm<ImageType, ImageType, ElxParamFileCLI3DUIDPolicy> AlgorithmType;
