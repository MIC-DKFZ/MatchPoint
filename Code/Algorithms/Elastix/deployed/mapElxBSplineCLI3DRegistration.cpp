...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/Elastix/deployed/mapElxBSplineCLI3DRegistration.cpp $
*/
...
mapGenerateAlgorithmUIDPolicyMacro(ElxBSplineCLI3DUIDPolicy, "de.dkfz.matchpoint.elastix.cli", "BSplineRegistration.3D", "1.0.0");

typedef map::core::discrete::Elements<3>::InternalImageType ImageType;
typedef map::algorithm::boxed::ElxBSplineCLIRegistrationAlgorithm<ImageType, ImageType, ElxBSplineCLI3DUIDPolicy> AlgorithmType;

typedef map::deployment::DeploymentDLLHelper<AlgorithmType> DLLHelperType;

/** @class ElxBSplineCLI3DImageRegistrationAlgorithm
