...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/Elastix/deployed/mapElxBSplineCLI2DRegistration.cpp $
*/
...
mapGenerateAlgorithmUIDPolicyMacro(ElxBSplineCLI2DUIDPolicy, "de.dkfz.matchpoint.elastix.cli", "BSplineRegistration.2D", "1.0.0");

typedef map::core::discrete::Elements<2>::InternalImageType ImageType;
typedef map::algorithm::boxed::ElxBSplineCLIRegistrationAlgorithm<ImageType, ImageType, ElxBSplineCLI2DUIDPolicy> AlgorithmType;

typedef map::deployment::DeploymentDLLHelper<AlgorithmType> DLLHelperType;

/** @class ElxBSplineCLI2DImageRegistrationAlgorithm
