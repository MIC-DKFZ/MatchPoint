...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/test/mapFixedImageToImageMetricPolicyTest.cpp $
*/
...
namespace map
{
	namespace testing
	{
		...
		int mapFixedImageToImageMetricPolicyTest(int, char* [])
		{
			...
			typedef ::itk::MeanSquaresImageToImageMetric<core::discrete::Elements<3>::InternalImageType, core::discrete::Elements<3>::InternalImageType> MetricType;
