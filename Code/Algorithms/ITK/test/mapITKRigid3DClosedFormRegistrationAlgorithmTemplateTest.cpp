...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/test/mapITKRigid3DClosedFormRegistrationAlgorithmTemplateTest.cpp $
*/
...
namespace map
{
	namespace testing
	{
		...
		int mapITKRigid3DClosedFormRegistrationAlgorithmTemplateTest(int argc, char *argv[])
		{
			...
			typedef algorithm::boxed::ITKRigid3DClosedFormRegistrationAlgorithmTemplate<>::Type RegistrationAlgorithmType;
