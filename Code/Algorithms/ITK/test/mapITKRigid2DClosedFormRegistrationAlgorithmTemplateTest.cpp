...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/test/mapITKRigid2DClosedFormRegistrationAlgorithmTemplateTest.cpp $
*/
...
namespace map
{
	namespace testing
	{
		...
		int mapITKRigid2DClosedFormRegistrationAlgorithmTemplateTest(int argc, char *argv[])
		{
			...
			typedef algorithm::boxed::ITKRigid2DClosedFormRegistrationAlgorithmTemplate<>::Type RegistrationAlgorithmType;
