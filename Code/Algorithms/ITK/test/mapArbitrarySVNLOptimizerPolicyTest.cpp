...
namespace map
{
	namespace testing
	{
		...
		namespace
		{
			class TestPolicy : public algorithm::itk::ArbitrarySVNLOptimizerPolicy
			{
			...
			public:
				using algorithm::itk::ArbitrarySVNLOptimizerPolicy::getOptimizerInternal;
		...
		int mapArbitrarySVNLOptimizerPolicyTest(int, char* [])
		{
