	...
	namespace algorithm
	{
		namespace boxed
		{
			...
			compileInfos(MetaPropertyVectorType& infos) const
			{
				...
				infos.push_back(map::algorithm::MetaPropertyInfo::New("GradientMagnitudeThreshold.1",
								typeid(double), true, true));
				infos.push_back(map::algorithm::MetaPropertyInfo::New("GradientSmoothingStandardDeviations.1",
								typeid(double), true, true));
				...
				infos.push_back(map::algorithm::MetaPropertyInfo::New("GradientMagnitudeThreshold.2",
								typeid(double), true, true));
				infos.push_back(map::algorithm::MetaPropertyInfo::New("GradientSmoothingStandardDeviations.2",
								typeid(double), true, true));
				...
				infos.push_back(map::algorithm::MetaPropertyInfo::New("GradientMagnitudeThreshold.3",
								typeid(double), true, true));
				infos.push_back(map::algorithm::MetaPropertyInfo::New("GradientSmoothingStandardDeviations.3",
								typeid(double), true, true));
				...
				infos.push_back(map::algorithm::MetaPropertyInfo::New("GradientMagnitudeThreshold.4",
								typeid(double), true, true));
				infos.push_back(map::algorithm::MetaPropertyInfo::New("GradientSmoothingStandardDeviations.4",
								typeid(double), true, true));
#endif
			};
			...
			doInterLevelSetup()
			{
				...
				if (this->getCurrentLevel() > 0)
				{
					...
					this->getInternalRegistrationMethod().SetGradientMagnitudeThreshold(
						this->_lvlGradientMagnitudeThreshold[this->getCurrentLevel()]);
					this->getInternalRegistrationMethod().SetGradientSmoothingStandardDeviations(
						this->_lvlGradientSmoothingStandardDeviations[this->getCurrentLevel()]);
				}
			};
