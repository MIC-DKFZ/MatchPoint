	...
	namespace algorithm
	{
		namespace boxed
		{
			...
			compileInfos(MetaPropertyVectorType& infos) const
			{
				...
				infos.push_back(map::algorithm::MetaPropertyInfo::New("GradientMagnitudeThreshold", typeid(double),
								true, true));
				infos.push_back(map::algorithm::MetaPropertyInfo::New("GradientSmoothingStandardDeviations",
								typeid(double), true, true));
#endif
			};
