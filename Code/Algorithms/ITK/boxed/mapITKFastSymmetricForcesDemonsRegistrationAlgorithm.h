	...
	namespace algorithm
	{
		namespace boxed
		{
			...
			*/
			...
			class ITKFastSymmetricForcesDemonsRegistrationAlgorithm : public itk::ITKPDEDeformableRegistrationAlgorithm<TImageType, TIdentificationPolicy, TDisplacementField, ::itk::FastSymmetricForcesDemonsRegistrationFilter<TImageType, TImageType, TDisplacementField> >
			{
			public:
				typedef ITKFastSymmetricForcesDemonsRegistrationAlgorithm < TImageType, TIdentificationPolicy, TDisplacementField > Self;
				typedef itk::ITKPDEDeformableRegistrationAlgorithm<TImageType, TIdentificationPolicy, TDisplacementField, ::itk::FastSymmetricForcesDemonsRegistrationFilter<TImageType, TImageType, TDisplacementField> >  Superclass;

				typedef ::itk::SmartPointer<Self>                                     Pointer;
				typedef ::itk::SmartPointer<const Self>                               ConstPointer;
				itkTypeMacro(ITKFastSymmetricForcesDemonsRegistrationAlgorithm, ITKPDEDeformableRegistrationAlgorithm);
