	...
	namespace algorithm
	{
		namespace boxed
		{
			...
			*/
			...
			class ITKSymmetricForcesDemonsRegistrationAlgorithm : public itk::ITKPDEDeformableRegistrationAlgorithm<TImageType, TIdentificationPolicy, TDisplacementField, ::itk::SymmetricForcesDemonsRegistrationFilter<TImageType, TImageType, TDisplacementField> >
			{
			public:
				typedef ITKSymmetricForcesDemonsRegistrationAlgorithm < TImageType, TIdentificationPolicy, TDisplacementField > Self;
				typedef itk::ITKPDEDeformableRegistrationAlgorithm<TImageType, TIdentificationPolicy, TDisplacementField, ::itk::SymmetricForcesDemonsRegistrationFilter<TImageType, TImageType, TDisplacementField> >  Superclass;
