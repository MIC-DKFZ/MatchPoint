	...
	namespace algorithm
	{
		namespace boxed
		{
			...
			*/
			...
			class ITKPDEDemonsRegistrationAlgorithm : public itk::ITKPDEDeformableRegistrationAlgorithm<TImageType, TIdentificationPolicy, TDisplacementField, ::itk::DemonsRegistrationFilter<TImageType, TImageType, TDisplacementField> >
			{
			public:
				typedef ITKPDEDemonsRegistrationAlgorithm < TImageType, TIdentificationPolicy, TDisplacementField > Self;
				typedef itk::ITKPDEDeformableRegistrationAlgorithm<TImageType, TIdentificationPolicy, TDisplacementField, ::itk::DemonsRegistrationFilter<TImageType, TImageType, TDisplacementField> >  Superclass;
