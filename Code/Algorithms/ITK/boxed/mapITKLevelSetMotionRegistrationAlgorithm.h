	...
	namespace algorithm
	{
		namespace boxed
		{
			...
			*/
			...
			class ITKLevelSetMotionRegistrationAlgorithm : public
				itk::ITKPDEDeformableRegistrationAlgorithm<TImageType, TIdentificationPolicy, TDisplacementField, ::itk::LevelSetMotionRegistrationFilter<TImageType, TImageType, TDisplacementField> >
			{
			public:
				typedef ITKLevelSetMotionRegistrationAlgorithm
				< TImageType, TIdentificationPolicy, TDisplacementField > Self;
				typedef itk::ITKPDEDeformableRegistrationAlgorithm<TImageType, TIdentificationPolicy, TDisplacementField, ::itk::LevelSetMotionRegistrationFilter<TImageType, TImageType, TDisplacementField> >
				Superclass;
