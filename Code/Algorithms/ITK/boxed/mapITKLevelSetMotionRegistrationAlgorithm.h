...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKLevelSetMotionRegistrationAlgorithm.h $
*/




#ifndef __ITK_LEVEL_SET_MOTION_REGISTRATION_ALGORITHM_H
#define __ITK_LEVEL_SET_MOTION_REGISTRATION_ALGORITHM_H
...
namespace map
{
	namespace algorithm
	{
		namespace boxed
		{
			...
			/*! @class ITKLevelSetMotionRegistrationAlgorithm
			...
			*/
			...
			class ITKLevelSetMotionRegistrationAlgorithm : public itk::ITKPDEDeformableRegistrationAlgorithm<TImageType, TIdentificationPolicy, TDisplacementField, ::itk::LevelSetMotionRegistrationFilter<TImageType, TImageType, TDisplacementField> >
			{
			public:
				typedef ITKLevelSetMotionRegistrationAlgorithm < TImageType, TIdentificationPolicy, TDisplacementField > Self;
				typedef itk::ITKPDEDeformableRegistrationAlgorithm<TImageType, TIdentificationPolicy, TDisplacementField, ::itk::LevelSetMotionRegistrationFilter<TImageType, TImageType, TDisplacementField> >  Superclass;

				typedef ::itk::SmartPointer<Self>                                     Pointer;
				typedef ::itk::SmartPointer<const Self>                               ConstPointer;
				itkTypeMacro(ITKLevelSetMotionRegistrationAlgorithm, ITKPDEDeformableRegistrationAlgorithm);
			...
			protected:
				...
				virtual ~ITKLevelSetMotionRegistrationAlgorithm();
			...
			private:
				ITKLevelSetMotionRegistrationAlgorithm(const Self &source);
...
#include "mapITKLevelSetMotionRegistrationAlgorithm.tpp"
#endif
