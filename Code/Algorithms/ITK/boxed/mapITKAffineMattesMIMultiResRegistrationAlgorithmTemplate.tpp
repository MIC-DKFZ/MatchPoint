...
// Subversion HeadURL: $HeadURL: https://svn.inet.dkfz-heidelberg.de/sbr/Sources/SBR-Projects/MatchPoint/trunk/Code/Algorithms/ITK/boxed/mapITKAffineMattesMIMultiResRegistrationAlgorithmTemplate.tpp $
*/


#ifndef __MAP_ITK_AFFINE_MATTES_MI_MULTI_RES_REGISTRATION_ALGORITHM_TEMPLATE_TPP
#define __MAP_ITK_AFFINE_MATTES_MI_MULTI_RES_REGISTRATION_ALGORITHM_TEMPLATE_TPP
...
namespace map
{
	namespace algorithm
	{
		namespace boxed
		{
			...
			ITKAffineMattesMIMultiResRegistrationAlgorithm < TMovingImage, TTargetImage, TUIDPolicy,
															TInterpolatorPolicy,
        ...
        int dimCount = TTargetImage::ImageDimension*TTargetImage::ImageDimension + TTargetImage::ImageDimension;
        int matrixEnd = TTargetImage::ImageDimension*TTargetImage::ImageDimension;
        ...
        for (int i = 0; i < dimCount; ++i)
        {
			...
			template < class TMovingImage, class TTargetImage,
					 ...
					 class TInterpolatorPolicy,
					 class TPyramideInitializationPolicy >
			typename ITKAffineMattesMIMultiResRegistrationAlgorithm < TMovingImage, TTargetImage, TUIDPolicy,
					 TInterpolatorPolicy,
