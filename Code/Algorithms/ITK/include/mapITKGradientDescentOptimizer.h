...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKGradientDescentOptimizer.h $
*/




#ifndef __ITK_GRADIENT_DESCENT_OPTIMIZER_H
#define __ITK_GRADIENT_DESCENT_OPTIMIZER_H
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			/*!
			This class is the template specialization for the itk::GradientDescentOptimizer.
			@ingroup ITK
			@ingroup OptimizerControl
			*/
			template<>
			class ITKOptimizerControl< ::itk::GradientDescentOptimizer> : public ITKSVNLOptimizerControlBase< ::itk::GradientDescentOptimizer>
			{
			public:
				typedef ITKOptimizerControl< ::itk::GradientDescentOptimizer> Self;
				typedef ITKSVNLOptimizerControlBase< ::itk::GradientDescentOptimizer> Superclass;
			...
			typedef ITKOptimizerControl< ::itk::GradientDescentOptimizer> GradientDescentOptimizerControl;
		}
	}
}
