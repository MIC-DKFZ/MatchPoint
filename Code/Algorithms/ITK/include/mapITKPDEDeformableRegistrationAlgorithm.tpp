...
namespace map
{
	namespace algorithm
	{
      ...
      template<class TMovingImage, class TTargetImage, class TIdentificationPolicy, class TInterpolatorPolicy, class TMetricPolicy, class TOptimizerPolicy, class TTransformPolicy, class TInternalRegistrationMethod>
			typename ITKPDEDeformableRegistrationAlgorithm<TMovingImage, TTargetImage, TIdentificationPolicy, TInterpolatorPolicy, TMetricPolicy, TOptimizerPolicy, TTransformPolicy, TInternalRegistrationMethod>::FieldRepRequirement::Type
			ITKPDEDeformableRegistrationAlgorithm<TMovingImage, TTargetImage, TIdentificationPolicy, TInterpolatorPolicy, TMetricPolicy, TOptimizerPolicy, TTransformPolicy, TInternalRegistrationMethod>::
			...
			template<class TMovingImage, class TTargetImage, class TIdentificationPolicy, class TInterpolatorPolicy, class TMetricPolicy, class TOptimizerPolicy, class TTransformPolicy, class TInternalRegistrationMethod>
			typename ITKPDEDeformableRegistrationAlgorithm<TMovingImage, TTargetImage, TIdentificationPolicy, TInterpolatorPolicy, TMetricPolicy, TOptimizerPolicy, TTransformPolicy, TInternalRegistrationMethod>::IterationCountType
			ITKPDEDeformableRegistrationAlgorithm<TMovingImage, TTargetImage, TIdentificationPolicy, TInterpolatorPolicy, TMetricPolicy, TOptimizerPolicy, TTransformPolicy, TInternalRegistrationMethod>::
			...
			template<class TMovingImage, class TTargetImage, class TIdentificationPolicy, class TInterpolatorPolicy, class TMetricPolicy, class TOptimizerPolicy, class TTransformPolicy, class TInternalRegistrationMethod>
			typename ITKPDEDeformableRegistrationAlgorithm<TMovingImage, TTargetImage, TIdentificationPolicy, TInterpolatorPolicy, TMetricPolicy, TOptimizerPolicy, TTransformPolicy, TInternalRegistrationMethod>::TransformParametersType
			ITKPDEDeformableRegistrationAlgorithm<TMovingImage, TTargetImage, TIdentificationPolicy, TInterpolatorPolicy, TMetricPolicy, TOptimizerPolicy, TTransformPolicy, TInternalRegistrationMethod>::
			...
			template<class TMovingImage, class TTargetImage, class TIdentificationPolicy, class TInterpolatorPolicy, class TMetricPolicy, class TOptimizerPolicy, class TTransformPolicy, class TInternalRegistrationMethod>
			typename ITKPDEDeformableRegistrationAlgorithm<TMovingImage, TTargetImage, TIdentificationPolicy, TInterpolatorPolicy, TMetricPolicy, TOptimizerPolicy, TTransformPolicy, TInternalRegistrationMethod>::InterimRegistrationPointer
			ITKPDEDeformableRegistrationAlgorithm<TMovingImage, TTargetImage, TIdentificationPolicy, TInterpolatorPolicy, TMetricPolicy, TOptimizerPolicy, TTransformPolicy, TInternalRegistrationMethod>::
			...
			prepSetInternalInputData()
			{
				...
				typename core::discrete::Elements<TTargetImage::ImageDimension>::ImageRegionType region = this->getTargetImage()->GetBufferedRegion();
				...
				if (this->getTargetMask().IsNotNull())
				{
					...
					if (this->getTargetMask()->ComputeBoundingBox())
					{
						...
						typename MaskedRegistrationAlgorithmBase<TMovingImage::ImageDimension, TTargetImage::ImageDimension>::TargetMaskBaseType::BoundingBoxType::Pointer spBBox = this->getTargetMask()->GetBoundingBox();
						...
						typename core::discrete::Elements<TTargetImage::ImageDimension>::ImageRegionType tempRegion(minIndex, size);
			...
			prepareAlgorithm()
			{
				...
				this->InvokeEvent(events::AlgorithmEvent(this, "Initializing itk multi resolution registration method."));
				...
				if (_onIterationObserver.IsNull())
				{
					...
					_onIterationObserver = core::ObserverSentinel::New(this->getOptimizerInternal()->getSVNLOptimizer(), ::itk::IterationEvent(), spCommand);
				}
				...
				if (_onGeneralOptimizerObserver.IsNull())
				{
					...
					_onGeneralOptimizerObserver = core::ObserverSentinel::New(this->getOptimizerInternal()->getSVNLOptimizer(), ::itk::AnyEvent(), spCommand);
				}
				...
				if (_onGeneralMetricObserver.IsNull())
				{
					...
					_onGeneralMetricObserver = core::ObserverSentinel::New(this->getMetricInternal()->getImageToImageMetric(), ::itk::AnyEvent(), spCommand);
				}
				...
				if (_onGeneralInterpolatorObserver.IsNull())
				{
					...
					_onGeneralInterpolatorObserver = core::ObserverSentinel::New(this->getInterpolatorInternal(), ::itk::AnyEvent(), spCommand);
				}
			...
			finalizeAlgorithm()
			{
				...
				spFinalTransformModel->getTransform()->SetParametersByValue(lastTransformParameters); //this line is need to ensure correct cloning for
			...
			template<class TMovingImage, class TTargetImage, class TIdentificationPolicy, class TInterpolatorPolicy, class TMetricPolicy, class TOptimizerPolicy, class TTransformPolicy, class TInternalRegistrationMethod>
			typename ITKPDEDeformableRegistrationAlgorithm<TMovingImage, TTargetImage, TIdentificationPolicy, TInterpolatorPolicy, TMetricPolicy, TOptimizerPolicy, TTransformPolicy, TInternalRegistrationMethod>::RegistrationPointer
			ITKPDEDeformableRegistrationAlgorithm<TMovingImage, TTargetImage, TIdentificationPolicy, TInterpolatorPolicy, TMetricPolicy, TOptimizerPolicy, TTransformPolicy, TInternalRegistrationMethod>::
			...
			template<class TMovingImage, class TTargetImage, class TIdentificationPolicy, class TInterpolatorPolicy, class TMetricPolicy, class TOptimizerPolicy, class TTransformPolicy, class TInternalRegistrationMethod>
			typename ITKPDEDeformableRegistrationAlgorithm<TMovingImage, TTargetImage, TIdentificationPolicy, TInterpolatorPolicy, TMetricPolicy, TOptimizerPolicy, TTransformPolicy, TInternalRegistrationMethod>::OptimizerMeasureType
			ITKPDEDeformableRegistrationAlgorithm<TMovingImage, TTargetImage, TIdentificationPolicy, TInterpolatorPolicy, TMetricPolicy, TOptimizerPolicy, TTransformPolicy, TInternalRegistrationMethod>::
			...
			template<class TMovingImage, class TTargetImage, class TIdentificationPolicy, class TInterpolatorPolicy, class TMetricPolicy, class TOptimizerPolicy, class TTransformPolicy, class TInternalRegistrationMethod>
			typename ITKPDEDeformableRegistrationAlgorithm<TMovingImage, TTargetImage, TIdentificationPolicy, TInterpolatorPolicy, TMetricPolicy, TOptimizerPolicy, TTransformPolicy, TInternalRegistrationMethod>::InternalRegistrationMethodType &
			ITKPDEDeformableRegistrationAlgorithm<TMovingImage, TTargetImage, TIdentificationPolicy, TInterpolatorPolicy, TMetricPolicy, TOptimizerPolicy, TTransformPolicy, TInternalRegistrationMethod>::
			...
			PrintSelf(std::ostream &os, ::itk::Indent indent) const
			{
				...
				MaskedRegistrationAlgorithmBase<TMovingImage::ImageDimension, TTargetImage::ImageDimension>::PrintSelf(os, indent);
			...
			template<class TMovingImage, class TTargetImage, class TIdentificationPolicy, class TInterpolatorPolicy, class TMetricPolicy, class TOptimizerPolicy, class TTransformPolicy, class TInternalRegistrationMethod>
			typename ITKPDEDeformableRegistrationAlgorithm<TMovingImage, TTargetImage, TIdentificationPolicy, TInterpolatorPolicy, TMetricPolicy, TOptimizerPolicy, TTransformPolicy, TInternalRegistrationMethod>::MetaPropertyPointer
			ITKPDEDeformableRegistrationAlgorithm<TMovingImage, TTargetImage, TIdentificationPolicy, TInterpolatorPolicy, TMetricPolicy, TOptimizerPolicy, TTransformPolicy, TInternalRegistrationMethod>::
