...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKRigid3DTransform.h $
*/




#ifndef __MAP_ITK_Rigid3D_TRANSFORM_H
#define __MAP_ITK_Rigid3D_TRANSFORM_H
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			/*!
			This class is the template specialization for the itk::Rigid3DTransform.
			@ingroup ITK
			@ingroup ITKTransformModel
			*/
			template<class TScalarType>
			class ITKTransformModel< ::itk::Rigid3DTransform<TScalarType> >:
				public map::core::ITKDimensionedTransformModel< ::itk::Rigid3DTransform, TScalarType>
			{
			public:
				typedef ITKTransformModel< ::itk::Rigid3DTransform<TScalarType> >  Self;
				typedef map::core::ITKDimensionedTransformModel< ::itk::Rigid3DTransform, TScalarType>  Superclass;
