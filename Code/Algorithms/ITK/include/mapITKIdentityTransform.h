...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKIdentityTransform.h $
*/




#ifndef __MAP_ITK_Identity_TRANSFORM_H
#define __MAP_ITK_Identity_TRANSFORM_H
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			/*!
			This class is the template specialization for the itk::IdentityTransform.
			@ingroup ITK
			@ingroup ITKTransformModel
			*/
			template<class TScalarType, unsigned int TDimensions>
			class ITKTransformModel< ::itk::IdentityTransform<TScalarType, TDimensions> >:
				public map::core::ITKUnaryTransformModel< ::itk::IdentityTransform, TScalarType, TDimensions>
			{
			public:
				typedef ITKTransformModel< ::itk::IdentityTransform<TScalarType, TDimensions> >  Self;
				typedef map::core::ITKUnaryTransformModel< ::itk::IdentityTransform, TScalarType, TDimensions>  Superclass;
