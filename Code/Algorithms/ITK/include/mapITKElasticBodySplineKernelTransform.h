	...
	namespace algorithm
	{
		namespace itk
		{
			...
			*/
			...
			{
			public:
				typedef ITKTransformModel< ::itk::ElasticBodySplineKernelTransform<TScalarType, TDimensions> >
				Self;
				typedef map::core::ITKUnaryTransformModel< ::itk::ElasticBodySplineKernelTransform, TScalarType, TDimensions>
				Superclass;
