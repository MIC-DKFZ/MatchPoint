...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKElasticBodySplineKernelTransform.h $
*/




#ifndef __MAP_ITK_ElasticBodySplineKernel_TRANSFORM_H
#define __MAP_ITK_ElasticBodySplineKernel_TRANSFORM_H
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			/*!
			This class is the template specialization for the itk::ElasticBodySplineKernelTransform.
			@ingroup ITK
			@ingroup ITKTransformModel
			*/
			template<class TScalarType, unsigned int TDimensions>
			class ITKTransformModel< ::itk::ElasticBodySplineKernelTransform<TScalarType, TDimensions> >:
				public map::core::ITKUnaryTransformModel< ::itk::ElasticBodySplineKernelTransform, TScalarType, TDimensions>
			{
			public:
				typedef ITKTransformModel< ::itk::ElasticBodySplineKernelTransform<TScalarType, TDimensions> >  Self;
				typedef map::core::ITKUnaryTransformModel< ::itk::ElasticBodySplineKernelTransform, TScalarType, TDimensions>  Superclass;
