...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKImageRegistrationAlgorithm.tpp $
*/
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			typename ITKImageRegistrationAlgorithm<TMovingImage, TTargetImage, TIdentificationPolicy, TInterpolatorPolicy, TMetricPolicy, TOptimizerPolicy, TTransformPolicy, TInternalRegistrationMethod>::UIDPointer
			...
			getUID() const
			{
        return TIdentificationPolicy::UID();
			};
      ...
      map::core::String
			...
			{
        return TIdentificationPolicy::AlgorithmProfile();
			};
      ...
      map::core::String
			...
			{
        return TIdentificationPolicy::AlgorithmDescription();
			};
