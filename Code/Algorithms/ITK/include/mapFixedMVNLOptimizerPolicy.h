...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapFixedMVNLOptimizerPolicy.h $
*/
	...
	namespace algorithm
	{
		namespace itk
		{
			...
			*/
			...
			class FixedMVNLOptimizerPolicy : public SealedOptimizerPolicy<TConcreteOptimizer>, public facet::ITKMVNLOptimizerGetterInterface, public facet::OptimizerGetterInterface
			{
			public:
