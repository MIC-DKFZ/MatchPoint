	...
	namespace algorithm
	{
		namespace itk
		{
			...
			*/
			...
			{
			public:
				typedef ITKTransformModel< ::itk::ElasticBodyReciprocalSplineKernelTransform<TScalarType, TDimensions> >
				Self;
				typedef map::core::ITKUnaryTransformModel< ::itk::ElasticBodyReciprocalSplineKernelTransform, TScalarType, TDimensions>
				Superclass;
