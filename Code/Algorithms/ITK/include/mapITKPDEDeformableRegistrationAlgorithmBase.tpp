		...
		namespace itk
		{
										 ...
										 const TargetRepresentationDescriptorType* pTargetRepresentation) const
			{
				...
				if (this->_currentIterationCount > 0)
				{
					...
					typedef core::FieldKernels<InterimRegistrationType::TargetDimensions, InterimRegistrationType::MovingDimensions>::PreCachedFieldBasedRegistrationKernel
					InverseKernelType;
			...
			finalizeAlgorithm()
			{
				...
				//now build the inverse kernel (main kernel of a image based registration algorithm)
				typedef core::FieldKernels<RegistrationType::TargetDimensions, RegistrationType::MovingDimensions>::PreCachedFieldBasedRegistrationKernel
				InverseKernelType;
