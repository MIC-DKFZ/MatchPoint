...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKPDEDeformableRegistrationAlgorithmBase.tpp $
*/
	...
	namespace algorithm
	{
      ...
      template < class TImageType, class TIdentificationPolicy, class TDisplacementField, class TInternalRegistrationFilter>
        ...
        MetaPropertyPointer prop = this->getProperty("NumberOfIterations");
			...
			template < class TImageType, class TIdentificationPolicy, class TDisplacementField, class TInternalRegistrationFilter>
			ITKPDEDeformableRegistrationAlgorithmBase<TImageType, TIdentificationPolicy, TDisplacementField, TInternalRegistrationFilter>::
			ITKPDEDeformableRegistrationAlgorithmBase() : _currentIterationCount(0), _matchHistograms(true), _thresholdAtMeanIntensity(true), _numberOfHistogramLevels(1024), _numberOfHistogramMatchPoints(7)
			{
      ...
      template < class TImageType, class TIdentificationPolicy, class TDisplacementField, class TInternalRegistrationFilter>
        ...
        infos.push_back(map::algorithm::MetaPropertyInfo::New("MaximumKernelWidth", typeid(unsigned int), true, true));
				infos.push_back(map::algorithm::MetaPropertyInfo::New("MaximumKernelError", typeid(double), true, true));
				infos.push_back(map::algorithm::MetaPropertyInfo::New("SmoothDisplacementField", typeid(bool), true, true));
				infos.push_back(map::algorithm::MetaPropertyInfo::New("DisplacementFieldStandardDeviations", typeid(double), true, true));
				infos.push_back(map::algorithm::MetaPropertyInfo::New("SmoothUpdateField", typeid(bool), true, true));
				infos.push_back(map::algorithm::MetaPropertyInfo::New("UpdateFieldStandardDeviations", typeid(double), true, true));
#endif
			};
