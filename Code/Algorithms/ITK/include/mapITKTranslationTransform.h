...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKTranslationTransform.h $
*/




#ifndef __MAP_ITK_TRANSLATION_TRANSFORM_H
#define __MAP_ITK_TRANSLATION_TRANSFORM_H
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			/*!
			This class is the template specialization for the itk::TranslationTransform.
			@ingroup ITK
			@ingroup ITKTransformModel
			*/
			template<class TScalarType, unsigned int TDimensions>
			class ITKTransformModel< ::itk::TranslationTransform<TScalarType, TDimensions> >:
				public map::core::ITKUnaryTransformModel< ::itk::TranslationTransform, TScalarType, TDimensions>
			{
			public:
				typedef ITKTransformModel< ::itk::TranslationTransform<TScalarType, TDimensions> >  Self;
				typedef map::core::ITKUnaryTransformModel< ::itk::TranslationTransform, TScalarType, TDimensions>  Superclass;
