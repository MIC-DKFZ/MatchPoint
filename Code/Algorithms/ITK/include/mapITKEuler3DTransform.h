...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKEuler3DTransform.h $
*/




#ifndef __MAP_ITK_Euler3D_TRANSFORM_H
#define __MAP_ITK_Euler3D_TRANSFORM_H
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			/*!
			This class is the template specialization for the itk::Euler3DTransform.
			@ingroup ITK
