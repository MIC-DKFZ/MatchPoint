...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKVersorTransform.h $
*/




#ifndef __MAP_ITK_Versor_TRANSFORM_H
#define __MAP_ITK_Versor_TRANSFORM_H
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			/*!
			This class is the template specialization for the itk::VersorTransform.
			@ingroup ITK
			@ingroup ITKTransformModel
			*/
			template<class TScalarType>
			class ITKTransformModel< ::itk::VersorTransform<TScalarType> >:
				public map::core::ITKDimensionedTransformModel< ::itk::VersorTransform, TScalarType>
			{
			public:
				typedef ITKTransformModel< ::itk::VersorTransform<TScalarType> >  Self;
				typedef map::core::ITKDimensionedTransformModel< ::itk::VersorTransform, TScalarType>  Superclass;
