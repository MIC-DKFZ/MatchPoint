...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKAffineTransform.h $
*/




#ifndef __MAP_ITK_AFFINE_TRANSFORM_H
#define __MAP_ITK_AFFINE_TRANSFORM_H
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			/*!
			This class is the template specialization for the itk::AffineTransform.
			@ingroup ITK
			@ingroup ITKTransformModel
			*/
			template<class TScalarType, unsigned int TDimensions>
			class ITKTransformModel< ::itk::AffineTransform<TScalarType, TDimensions> >:
				public map::core::ITKUnaryTransformModel< ::itk::AffineTransform, TScalarType, TDimensions>
			{
			public:
				typedef ITKTransformModel< ::itk::AffineTransform<TScalarType, TDimensions> >  Self;
				typedef map::core::ITKUnaryTransformModel< ::itk::AffineTransform, TScalarType, TDimensions>  Superclass;
