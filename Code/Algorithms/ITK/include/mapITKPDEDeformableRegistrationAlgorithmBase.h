...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKPDEDeformableRegistrationAlgorithmBase.h $
*/
	...
	namespace algorithm
	{
		namespace itk
		{
			...
			*/
			...
			class ITKPDEDeformableRegistrationAlgorithmBase : public IterativeRegistrationAlgorithm<TImageType::ImageDimension, TImageType::ImageDimension>,
				public ImageRegistrationAlgorithmBase<TImageType, TImageType>,
				public MetaPropertyAlgorithmBase,
				public TIdentificationPolicy
			{
			public:
				typedef ITKPDEDeformableRegistrationAlgorithmBase < TImageType, TIdentificationPolicy, TDisplacementField, TInternalRegistrationFilter > Self;
