...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKLandmarkKernelRegistrationAlgorithm.tpp $
*/
	...
	namespace algorithm
	{
		namespace itk
		{
			...
			finalizeAlgorithm()
			{
				...
				typedef core::NullRegistrationKernel<RegistrationType::MovingDimensions, RegistrationType::TargetDimensions> DirectKernelType;
			...
			void
			ITKLandmarkKernelRegistrationAlgorithm<TPointSet, TITKTransform, TIdentificationPolicy>::
			convertPointSetToKernelPointSet(const TPointSet *ps, typename TITKTransform::PointSetPointer &kernelPS)
			{
