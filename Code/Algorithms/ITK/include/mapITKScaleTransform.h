...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKScaleTransform.h $
*/




#ifndef __MAP_ITK_SCALE_TRANSFORM_H
#define __MAP_ITK_SCALE_TRANSFORM_H
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			/*!
			This class is the template specialization for the itk::ScaleTransform.
			@ingroup ITK
			@ingroup ITKTransformModel
			*/
			template<class TScalarType, unsigned int TDimensions>
			class ITKTransformModel< ::itk::ScaleTransform<TScalarType, TDimensions> >:
				public map::core::ITKUnaryTransformModel< ::itk::ScaleTransform, TScalarType, TDimensions>
			{
			public:
				typedef ITKTransformModel< ::itk::ScaleTransform<TScalarType, TDimensions> >  Self;
				typedef map::core::ITKUnaryTransformModel< ::itk::ScaleTransform, TScalarType, TDimensions>  Superclass;
