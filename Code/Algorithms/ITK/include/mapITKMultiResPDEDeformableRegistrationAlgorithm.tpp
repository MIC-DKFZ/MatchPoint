...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			{
				InternalMultiResRegFilterType::NumberOfIterationsType iterations = this->_multiResFilter->GetNumberOfIterations();
			...
			ITKMultiResPDEDeformableRegistrationAlgorithm()
			{
				...
				_multiResFilter = InternalMultiResRegFilterType::New();
			};
        ...
        this->_multiResFilter->SetRegistrationFilter(&(this->getInternalRegistrationMethod()));
			...
			prepPerpareInternalInputData()
			{
				...
				this->InvokeEvent(events::AlgorithmEvent(this, "Pass resolution level count to itk registration method."));
			...
			{
				//Connect images
				this->InvokeEvent(events::AlgorithmEvent(this, "Connect images to itk multi res PDE registration filter."));
				this->_multiResFilter->SetFixedImage(_spInternalTargetImage);
				this->_multiResFilter->SetMovingImage(_spInternalMovingImage);
			}
