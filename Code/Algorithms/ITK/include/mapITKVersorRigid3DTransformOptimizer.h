...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKVersorRigid3DTransformOptimizer.h $
*/
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			*/
			template<>
			class ITKOptimizerControl< ::itk::VersorRigid3DTransformOptimizer> : public ITKSVNLOptimizerControlBase< ::itk::VersorRigid3DTransformOptimizer>
			{
			public:
			...
			typedef ITKOptimizerControl< ::itk::VersorRigid3DTransformOptimizer> VersorRigid3DTransformOptimizerControl;
