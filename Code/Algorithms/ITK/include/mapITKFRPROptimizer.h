...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			*/
			template<>
			class ITKOptimizerControl< ::itk::FRPROptimizer> : public
				ITKSVNLOptimizerControlBase< ::itk::FRPROptimizer>
			{
			public:
			...
			protected:
											...
											ConcreteOptimizerType* destination) const
				{
					...
					mapLogInfoMacro( <<
									 "Cloning assumes that the FRPR optimizer should be cloned with set to Fletch Reeves style (default). Because there is no possibility to deduce the style of the source instance.");
				};
