...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKSPSAOptimizer.h $
*/
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			*/
			template<>
			class ITKOptimizerControl< ::itk::SPSAOptimizer> : public ITKSVNLOptimizerControlBase< ::itk::SPSAOptimizer>
			{
			public:
