...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKCenteredSimilarity2DTransform.h $
*/




#ifndef __MAP_ITK_CenteredSimilarity2D_TRANSFORM_H
#define __MAP_ITK_CenteredSimilarity2D_TRANSFORM_H
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			/*!
			This class is the template specialization for the itk::CenteredSimilarity2DTransform.
			@ingroup ITK
			@ingroup ITKTransformModel
			*/
			template<class TScalarType>
			class ITKTransformModel< ::itk::CenteredSimilarity2DTransform<TScalarType> >:
				public map::core::ITKDimensionedTransformModel< ::itk::CenteredSimilarity2DTransform, TScalarType>
			{
			public:
				typedef ITKTransformModel< ::itk::CenteredSimilarity2DTransform<TScalarType> >  Self;
				typedef map::core::ITKDimensionedTransformModel< ::itk::CenteredSimilarity2DTransform, TScalarType>  Superclass;
