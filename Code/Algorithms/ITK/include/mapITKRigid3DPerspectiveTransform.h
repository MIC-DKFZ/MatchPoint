...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKRigid3DPerspectiveTransform.h $
*/




#ifndef __MAP_ITK_Rigid3DPerspective_TRANSFORM_H
#define __MAP_ITK_Rigid3DPerspective_TRANSFORM_H
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			/*!
			This class is the template specialization for the itk::Rigid3DPerspectiveTransform.
			@ingroup ITK
			@ingroup ITKTransformModel
			*/
			template<class TScalarType>
			class ITKTransformModel< ::itk::Rigid3DPerspectiveTransform<TScalarType> >:
				public map::core::ITKDimensionedTransformModel< ::itk::Rigid3DPerspectiveTransform, TScalarType>
			{
			public:
				typedef ITKTransformModel< ::itk::Rigid3DPerspectiveTransform<TScalarType> >  Self;
				typedef map::core::ITKDimensionedTransformModel< ::itk::Rigid3DPerspectiveTransform, TScalarType>  Superclass;
				...
				{
					matrix = Superclass::getConcreteTransform()->GetRotationMatrix();
