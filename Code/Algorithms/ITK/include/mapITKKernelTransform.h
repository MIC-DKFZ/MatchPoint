...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKKernelTransform.h $
*/




#ifndef __MAP_ITK_Kernel_TRANSFORM_H
#define __MAP_ITK_Kernel_TRANSFORM_H
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			/*!
			This class is the template specialization for the itk::KernelTransform.
			@ingroup ITK
			@ingroup ITKTransformModel
			*/
			template<class TScalarType, unsigned int TDimensions>
			class ITKTransformModel< ::itk::KernelTransform<TScalarType, TDimensions> >:
				public map::core::ITKUnaryTransformModel< ::itk::KernelTransform, TScalarType, TDimensions>
			{
			public:
				typedef ITKTransformModel< ::itk::KernelTransform<TScalarType, TDimensions> >  Self;
				typedef map::core::ITKUnaryTransformModel< ::itk::KernelTransform, TScalarType, TDimensions>  Superclass;
