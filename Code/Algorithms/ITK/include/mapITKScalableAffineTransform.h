...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKScalableAffineTransform.h $
*/
		...
		namespace itk
		{
			...
			*/
			...
			public:
				...
				typedef map::core::ITKUnaryTransformModel< ::itk::ScalableAffineTransform, TScalarType, TDimensions>  Superclass;
