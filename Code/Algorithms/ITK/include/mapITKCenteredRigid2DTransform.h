...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKCenteredRigid2DTransform.h $
*/




#ifndef __MAP_ITK_CenteredRigid2D_TRANSFORM_H
#define __MAP_ITK_CenteredRigid2D_TRANSFORM_H
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			/*!
			This class is the template specialization for the itk::CenteredRigid2DTransform.
			@ingroup ITK
			@ingroup ITKTransformModel
			*/
			template<class TScalarType>
			class ITKTransformModel< ::itk::CenteredRigid2DTransform<TScalarType> >:
				public map::core::ITKDimensionedTransformModel< ::itk::CenteredRigid2DTransform, TScalarType>
			{
			public:
				typedef ITKTransformModel< ::itk::CenteredRigid2DTransform<TScalarType> >  Self;
				typedef map::core::ITKDimensionedTransformModel< ::itk::CenteredRigid2DTransform, TScalarType>  Superclass;
