...
#ifndef __ITK_POINTSET_TO_POINTSET_METRIC_CONTROL_BASE_H
#define __ITK_POINTSET_TO_POINTSET_METRIC_CONTROL_BASE_H
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			/*! @class ITKPointSetToPointSetMetricControlBase
			This class serves as base class for all
			template specialization of itk::PointSetToPointSetMetrics.
			It realizes some basic metric handling, to reduce the code in the control classes
			@remark ITKPointSetToPointSetMetricControlBase instantiates a concrete metric when constructed.
			You can set a new one, but ITKPointSetToPointSetMetricControlBase has always an optimizer under control.
			...
			*/
			...
			public:
				...
				itkTypeMacro(ITKPointSetToPointSetMetricControlBase, ITKPointSetToPointSetMetricControlInterface);
				...
				typedef typename Superclass::MVMetricBaseType MVMetricBaseType;
				typedef typename Superclass::PointSetToPointSetMetricBaseType PointSetToPointSetMetricBaseType;
			...
			protected:
				virtual ~ITKPointSetToPointSetMetricControlBase();
