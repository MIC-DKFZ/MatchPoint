	...
	namespace algorithm
	{
		namespace itk
		{
			...
			*/
			...
			{
			public:
				typedef ITKTransformModel< ::itk::ThinPlateR2LogRSplineKernelTransform<TScalarType, TDimensions> >
				Self;
				typedef map::core::ITKUnaryTransformModel< ::itk::ThinPlateR2LogRSplineKernelTransform, TScalarType, TDimensions>
				Superclass;
