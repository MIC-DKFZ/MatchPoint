...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKThinPlateR2LogRSplineKernelTransform.h $
*/




#ifndef __MAP_ITK_ThinPlateR2LogRSplineKernel_TRANSFORM_H
#define __MAP_ITK_ThinPlateR2LogRSplineKernel_TRANSFORM_H
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			/*!
			This class is the template specialization for the itk::ThinPlateR2LogRSplineKernelTransform.
			@ingroup ITK
			@ingroup ITKTransformModel
			*/
			template<class TScalarType, unsigned int TDimensions>
			class ITKTransformModel< ::itk::ThinPlateR2LogRSplineKernelTransform<TScalarType, TDimensions> >:
				public map::core::ITKUnaryTransformModel< ::itk::ThinPlateR2LogRSplineKernelTransform, TScalarType, TDimensions>
			{
			public:
				typedef ITKTransformModel< ::itk::ThinPlateR2LogRSplineKernelTransform<TScalarType, TDimensions> >  Self;
				typedef map::core::ITKUnaryTransformModel< ::itk::ThinPlateR2LogRSplineKernelTransform, TScalarType, TDimensions>  Superclass;
