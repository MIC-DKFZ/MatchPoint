...
#ifndef __MAP_ITK_FixedCenterOfRotationAffine_TRANSFORM_H
#define __MAP_ITK_FixedCenterOfRotationAffine_TRANSFORM_H
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			/*!
			This class is the template specialization for the itk::FixedCenterOfRotationAffineTransform.
			@ingroup ITK
			@ingroup ITKTransformModel
			*/
			template<class TScalarType, unsigned int TDimensions>
			class ITKTransformModel< ::itk::FixedCenterOfRotationAffineTransform<TScalarType, TDimensions> >:
