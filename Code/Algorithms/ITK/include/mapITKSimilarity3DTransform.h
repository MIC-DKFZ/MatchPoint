...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKSimilarity3DTransform.h $
*/




#ifndef __MAP_ITK_Similarity3D_TRANSFORM_H
#define __MAP_ITK_Similarity3D_TRANSFORM_H
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			/*!
			This class is the template specialization for the itk::Similarity3DTransform.
			@ingroup ITK
			@ingroup ITKTransformModel
			*/
			template<class TScalarType>
			class ITKTransformModel< ::itk::Similarity3DTransform<TScalarType> >:
				public map::core::ITKDimensionedTransformModel< ::itk::Similarity3DTransform, TScalarType>
			{
			public:
				typedef ITKTransformModel< ::itk::Similarity3DTransform<TScalarType> >  Self;
				typedef map::core::ITKDimensionedTransformModel< ::itk::Similarity3DTransform, TScalarType>  Superclass;
