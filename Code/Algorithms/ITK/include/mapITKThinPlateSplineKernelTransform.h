...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKThinPlateSplineKernelTransform.h $
*/




#ifndef __MAP_ITK_ThinPlateSplineKernel_TRANSFORM_H
#define __MAP_ITK_ThinPlateSplineKernel_TRANSFORM_H
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			/*!
			This class is the template specialization for the itk::ThinPlateSplineKernelTransform.
			@ingroup ITK
			@ingroup ITKTransformModel
			*/
			template<class TScalarType, unsigned int TDimensions>
			class ITKTransformModel< ::itk::ThinPlateSplineKernelTransform<TScalarType, TDimensions> >:
				public map::core::ITKUnaryTransformModel< ::itk::ThinPlateSplineKernelTransform, TScalarType, TDimensions>
			{
			public:
				typedef ITKTransformModel< ::itk::ThinPlateSplineKernelTransform<TScalarType, TDimensions> >  Self;
				typedef map::core::ITKUnaryTransformModel< ::itk::ThinPlateSplineKernelTransform, TScalarType, TDimensions>  Superclass;
