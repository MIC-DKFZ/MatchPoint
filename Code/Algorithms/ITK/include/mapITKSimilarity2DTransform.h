...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKSimilarity2DTransform.h $
*/
		...
		namespace itk
		{
			...
			*/
			...
			public:
				...
				typedef map::core::ITKDimensionedTransformModel< ::itk::Similarity2DTransform, TScalarType>  Superclass;
