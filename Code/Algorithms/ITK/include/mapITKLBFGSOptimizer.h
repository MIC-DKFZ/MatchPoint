...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKLBFGSOptimizer.h $
*/
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			*/
			template<>
			class ITKOptimizerControl< ::itk::LBFGSOptimizer> : public ITKSVNLOptimizerControlBase< ::itk::LBFGSOptimizer>
			{
			public:
			...
			protected:
				...
				virtual void copyProperties(const ConcreteOptimizerType *source, ConcreteOptimizerType *destination) const
				{
					...
					destination->SetMaximumNumberOfFunctionEvaluations(nonConstSource->GetMaximumNumberOfFunctionEvaluations());
