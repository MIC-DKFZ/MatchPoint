...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKCenteredAffineTransform.h $
*/




#ifndef __MAP_ITK_CenteredAffine_TRANSFORM_H
#define __MAP_ITK_CenteredAffine_TRANSFORM_H
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			/*!
			This class is the template specialization for the itk::CenteredAffineTransform.
			@ingroup ITK
			@ingroup ITKTransformModel
			*/
			template<class TScalarType, unsigned int TDimensions>
			class ITKTransformModel< ::itk::CenteredAffineTransform<TScalarType, TDimensions> >:
				public map::core::ITKUnaryTransformModel< ::itk::CenteredAffineTransform, TScalarType, TDimensions>
			{
			public:
				typedef ITKTransformModel< ::itk::CenteredAffineTransform<TScalarType, TDimensions> >  Self;
				typedef map::core::ITKUnaryTransformModel< ::itk::CenteredAffineTransform, TScalarType, TDimensions>  Superclass;
