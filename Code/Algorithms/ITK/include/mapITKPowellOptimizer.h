...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKPowellOptimizer.h $
*/
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			*/
			template<>
			class ITKOptimizerControl< ::itk::PowellOptimizer> : public ITKSVNLOptimizerControlBase< ::itk::PowellOptimizer>
			{
			public:
