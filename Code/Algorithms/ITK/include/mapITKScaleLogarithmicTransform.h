...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKScaleLogarithmicTransform.h $
*/




#ifndef __MAP_ITK_ScaleLogarithmic_TRANSFORM_H
#define __MAP_ITK_ScaleLogarithmic_TRANSFORM_H
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			/*!
			This class is the template specialization for the itk::ScaleLogarithmicTransform.
			@ingroup ITK
			@ingroup ITKTransformModel
			*/
			template<class TScalarType, unsigned int TDimensions>
			class ITKTransformModel< ::itk::ScaleLogarithmicTransform<TScalarType, TDimensions> >:
				public map::core::ITKUnaryTransformModel< ::itk::ScaleLogarithmicTransform, TScalarType, TDimensions>
			{
			public:
				typedef ITKTransformModel< ::itk::ScaleLogarithmicTransform<TScalarType, TDimensions> >  Self;
				typedef map::core::ITKUnaryTransformModel< ::itk::ScaleLogarithmicTransform, TScalarType, TDimensions>  Superclass;
				...
				{
					typename TransformType::ScaleType scale = Superclass::getConcreteTransform()->GetScale();
					typename TransformType::InputPointType center = Superclass::getConcreteTransform()->GetCenter();
