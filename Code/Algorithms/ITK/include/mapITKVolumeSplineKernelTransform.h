...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKVolumeSplineKernelTransform.h $
*/




#ifndef __MAP_ITK_VolumeSplineKernel_TRANSFORM_H
#define __MAP_ITK_VolumeSplineKernel_TRANSFORM_H
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			/*!
			This class is the template specialization for the itk::VolumeSplineKernelTransform.
			@ingroup ITK
			@ingroup ITKTransformModel
			*/
			template<class TScalarType, unsigned int TDimensions>
			class ITKTransformModel< ::itk::VolumeSplineKernelTransform<TScalarType, TDimensions> >:
				public map::core::ITKUnaryTransformModel< ::itk::VolumeSplineKernelTransform, TScalarType, TDimensions>
			{
			public:
				typedef ITKTransformModel< ::itk::VolumeSplineKernelTransform<TScalarType, TDimensions> >  Self;
				typedef map::core::ITKUnaryTransformModel< ::itk::VolumeSplineKernelTransform, TScalarType, TDimensions>  Superclass;
