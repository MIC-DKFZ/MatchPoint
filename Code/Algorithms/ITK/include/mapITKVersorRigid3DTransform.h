...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKVersorRigid3DTransform.h $
*/




#ifndef __MAP_ITK_VersorRigid3D_TRANSFORM_H
#define __MAP_ITK_VersorRigid3D_TRANSFORM_H
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			/*!
			This class is the template specialization for the itk::VersorRigid3DTransform.
			@ingroup ITK
			@ingroup ITKTransformModel
			*/
			template<class TScalarType>
			class ITKTransformModel< ::itk::VersorRigid3DTransform<TScalarType> >:
				public map::core::ITKDimensionedTransformModel< ::itk::VersorRigid3DTransform, TScalarType>
			{
			public:
				typedef ITKTransformModel< ::itk::VersorRigid3DTransform<TScalarType> >  Self;
				typedef map::core::ITKDimensionedTransformModel< ::itk::VersorRigid3DTransform, TScalarType>  Superclass;
