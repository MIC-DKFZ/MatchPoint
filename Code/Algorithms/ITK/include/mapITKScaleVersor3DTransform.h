...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKScaleVersor3DTransform.h $
*/




#ifndef __MAP_ITK_ScaleVersor3D_TRANSFORM_H
#define __MAP_ITK_ScaleVersor3D_TRANSFORM_H
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			/*!
			This class is the template specialization for the itk::ScaleVersor3DTransform.
			@ingroup ITK
			@ingroup ITKTransformModel
			*/
			template<class TScalarType>
			class ITKTransformModel< ::itk::ScaleVersor3DTransform<TScalarType> >:
				public map::core::ITKDimensionedTransformModel< ::itk::ScaleVersor3DTransform, TScalarType>
			{
			public:
				typedef ITKTransformModel< ::itk::ScaleVersor3DTransform<TScalarType> >  Self;
				typedef map::core::ITKDimensionedTransformModel< ::itk::ScaleVersor3DTransform, TScalarType>  Superclass;
