...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/include/mapITKAmoebaOptimizer.h $
*/
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			*/
			template<>
			class ITKOptimizerControl< ::itk::AmoebaOptimizer> : public ITKSVNLOptimizerControlBase< ::itk::AmoebaOptimizer>
			{
			public:
