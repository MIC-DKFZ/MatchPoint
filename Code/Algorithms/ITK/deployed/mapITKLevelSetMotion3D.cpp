...
#include "mapITKLevelSetMotionRegistrationAlgorithm.h"
#include "mapConfigure.h"

#include "ITKLevelSetMotion3D_ProfileResource.h"
typedef map::core::discrete::Elements<3>::InternalImageType ImageType;
typedef map::algorithm::boxed::ITKLevelSetMotionRegistrationAlgorithm<ImageType, map::algorithm::ITKLevelSetMotion3DUIDPolicy> AlgorithmType;
