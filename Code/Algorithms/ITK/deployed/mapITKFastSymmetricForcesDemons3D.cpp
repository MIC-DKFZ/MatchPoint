...
typedef map::algorithm::boxed::ITKFastSymmetricForcesDemonsRegistrationAlgorithm<ImageType, map::algorithm::ITKFastSymmetricForcesDemons3DUIDPolicy> AlgorithmType;
