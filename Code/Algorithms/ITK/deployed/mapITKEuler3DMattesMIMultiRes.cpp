...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/ITK/deployed/mapITKEuler3DMattesMIMultiRes.cpp $
*/
...
mapGenerateAlgorithmUIDPolicyMacro(DefaultCommonEuler3DMattesMIMultiResAlgorithm3DUIDPolicy, "de.dkfz.matchpoint.common", "Euler3DMattesMIMultiResAlgorithm.3D.default", "1.0.1");

typedef map::core::discrete::Elements<3>::InternalImageType ImageType;
typedef map::algorithm::boxed::ITKEuler3DMattesMIMultiResRegistrationAlgorithm<ImageType, ImageType, DefaultCommonEuler3DMattesMIMultiResAlgorithm3DUIDPolicy> AlgorithmType;

typedef map::deployment::DeploymentDLLHelper<AlgorithmType> DLLHelperType;

/** @class ITKEuler3DMattesMIMultiResAlgorithm_default
 * @ingroup Data_image Model_rigid MetaProperty Det_comp_iterative Det_stochastic Det_res_multi Dim_3D_3D Mod_multi PreInit_Geo PreInit_Moments
 */
