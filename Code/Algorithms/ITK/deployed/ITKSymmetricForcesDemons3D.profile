...
SET(ALGORITHM_PROFILE_UID_Name "Demons.SymmetricForces.3D.default")
SET(ALGORITHM_PROFILE_UID_Version "1.0.0")

SET(ALGORITHM_PROFILE_Description "Deformable 3D registration algorithm based on the concept of Thiron's demons using symmetric forces. This algorithm is only suitable for mono modal tasks.")
