...
#include "ITKEuler3DMS_ProfileResource.h"
typedef map::core::discrete::Elements<3>::InternalImageType ImageType;
typedef map::algorithm::boxed::ITKEuler3DMSRegistrationAlgorithm<ImageType, ImageType, map::algorithm::ITKEuler3DMSUIDPolicy> AlgorithmType;
