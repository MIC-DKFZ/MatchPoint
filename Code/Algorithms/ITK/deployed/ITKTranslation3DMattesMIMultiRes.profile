...
SET(ALGORITHM_PROFILE_UID_Name "TranslationMattesMIMultiResAlgorithm.3D.default")
SET(ALGORITHM_PROFILE_UID_Version "1.1.0")

SET(ALGORITHM_PROFILE_Description "Simple 3D registration algorithm, that only allows translation, is using mutual information as metric and a 3 level multi resolution approach.")
