...
#include "ITKPDEDemons3D_ProfileResource.h"
typedef map::core::discrete::Elements<3>::InternalImageType ImageType;
typedef map::algorithm::boxed::ITKPDEDemonsRegistrationAlgorithm<ImageType, map::algorithm::ITKPDEDemons3DUIDPolicy> AlgorithmType;
