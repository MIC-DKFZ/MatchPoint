...
#include "ITKRigid2DMattesMI_ProfileResource.h"

typedef map::core::discrete::Elements<2>::InternalImageType ImageType;
typedef map::algorithm::boxed::ITKRigid2DMattesMIRegistrationAlgorithm<ImageType, ImageType, ::map::algorithm::ITKRigid2DMattesMIUIDPolicy> AlgorithmType;
