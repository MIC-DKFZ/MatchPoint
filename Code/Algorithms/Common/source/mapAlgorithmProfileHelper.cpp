		...
		namespace profile
		{
				...
				const core::String& profileStr)
			{
				...
				try
				{
					...
					::map::structuredData::Element::ConstSubElementIteratorType profilePos =
						::map::structuredData::findNextSubElement(spRoot->getSubElementBegin(), spRoot->getSubElementEnd(),
								tags::AlgorithmProfile);
				...
				{
					mapLogDebugStaticMacro( << "Exception while parsing algorithm profile: Profile string: " <<
											profileStr);
				}
