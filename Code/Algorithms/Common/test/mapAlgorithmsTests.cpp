...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/Common/test/mapAlgorithmsTests.cpp $
*/
...
namespace map
{
	namespace testing
	{
		...
		void registerTests()
		{
			LIT_REGISTER_TEST(mapRegistrationAlgorithmTest);
			LIT_REGISTER_TEST(mapRegistrationAlgorithmBaseTest);
			LIT_REGISTER_TEST(mapIterativeAlgorithmBaseTest);
			LIT_REGISTER_TEST(mapIterativeRegistrationAlgorithmTest);
			LIT_REGISTER_TEST(mapImageRegistrationAlgorithmBaseTest);
			LIT_REGISTER_TEST(mapMaskedRegistrationAlgorithmBaseTest);
			LIT_REGISTER_TEST(mapOptimizerControlInterfaceTest);
			LIT_REGISTER_TEST(mapMetaPropertyInfoTest);
			LIT_REGISTER_TEST(mapMetaPropertyAlgorithmBaseTest);
			LIT_REGISTER_TEST(mapUIDTest);
