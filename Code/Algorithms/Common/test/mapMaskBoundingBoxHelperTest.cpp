...
// Subversion HeadURL: $HeadURL: https://svn/sbr/Sources/SBR-Projects/MatchPoint/trunk/Code/Algorithms/Common/test/mapMetaPropertyInfoTest.cpp $
*/
...
namespace map
{
	namespace testing
	{
      ...
      CHECK_THROW(map::algorithm::MaskBoundingBoxHelper<2>::computeBoundingImageRegion(NULL,image,region));
      CHECK_THROW(map::algorithm::MaskBoundingBoxHelper<2>::computeBoundingImageRegion(mask,NULL,region));
      CHECK_THROW(map::algorithm::MaskBoundingBoxHelper<2>::computeBoundingImageRegion(NULL,NULL,region));
