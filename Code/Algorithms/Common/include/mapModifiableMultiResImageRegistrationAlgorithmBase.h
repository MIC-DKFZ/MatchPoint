...
namespace map
{
	namespace algorithm
	{
		...
		class ModifiableMultiResImageRegistrationAlgorithmBase: public MultiResImageRegistrationAlgorithmBase<TMovingImage, TTargetImage, TPyramidesPolicy>, 
		...
		public:
			...
			typedef ModifiableMultiResImageRegistrationAlgorithmBase<MovingImageType, TargetImageType, TPyramidesPolicy > Self;
			typedef MultiResImageRegistrationAlgorithmBase<MovingImageType, TargetImageType, TPyramidesPolicy > Superclass;
