    ...
    namespace fsl
    {
      ...
      */
      ...
      protected:
        ...
        typedef ::itk::AffineTransform<map::core::continuous::ScalarType, TTargetImage::ImageDimension>
        ModelType;
        ...
        * The variable is set by prepareAlgorithm() to _spMovingImage before calling prepareInternalInputData().
        ...
        * The variable is set by prepareAlgorithm() to _spTargetImage before calling prepareInternalInputData().
        * (e.g.: An algorithm always normalizes an image before registration. Then the algorithm can use the prepareInternalInputData()
