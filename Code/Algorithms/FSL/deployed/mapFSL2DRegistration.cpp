...
// Subversion HeadURL: $HeadURL: http://sidt-hpc1/dkfz_repository/NotMeVisLab/SIDT/MatchPoint/trunk/Code/Algorithms/FSL/deployed/mapFSL2DRegistration.cpp $
*/
...
mapGenerateAlgorithmUIDPolicyMacro(FSL2DUIDPolicy, "de.dkfz.matchpoint.fsl", "FSL.wrapper.2D", "1.0.0");

typedef map::core::discrete::Elements<2>::InternalImageType ImageType;
typedef map::algorithm::fsl::FSLRegistrationAlgorithm<ImageType, ImageType, FSL2DUIDPolicy> AlgorithmType;

typedef map::deployment::DeploymentDLLHelper<AlgorithmType> DLLHelperType;

/** @class FSL2DImageRegistrationAlgorithm
