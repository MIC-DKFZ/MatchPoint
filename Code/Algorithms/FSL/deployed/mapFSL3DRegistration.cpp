...
mapGenerateAlgorithmUIDPolicyMacro(FSL3DUIDPolicy, "de.dkfz.matchpoint.fsl", "FSL.wrapper.3D", "1.0.0");

typedef map::core::discrete::Elements<3>::InternalImageType ImageType;
typedef map::algorithm::fsl::FSLRegistrationAlgorithm<ImageType, ImageType, FSL3DUIDPolicy> FSL3DAlgorithmType;

typedef map::deployment::DeploymentDLLHelper<FSL3DAlgorithmType> DLLHelperType;
