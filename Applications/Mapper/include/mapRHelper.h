    ...
    namespace mapR
    {
      ...
      void handleGenericImage(const ApplicationData& appData)
      {
        ...
        case ::itk::ImageIOBase::UCHAR:
          {
            TProcessingPolicy<unsigned char, IDimension>::processData(appData); break;
          }

        case ::itk::ImageIOBase::CHAR:
          {
            TProcessingPolicy<char, IDimension>::processData(appData); break;
          }

        case ::itk::ImageIOBase::USHORT:
          {
            TProcessingPolicy<unsigned short, IDimension>::processData(appData); break;
          }

        case ::itk::ImageIOBase::SHORT:
          {
            TProcessingPolicy<short, IDimension>::processData(appData); break;
          }

        case ::itk::ImageIOBase::UINT:
          {
            TProcessingPolicy<unsigned int, IDimension>::processData(appData); break;
          }

        case ::itk::ImageIOBase::INT:
          {
            TProcessingPolicy<int, IDimension>::processData(appData); break;
          }

        case ::itk::ImageIOBase::ULONG:
          {
            TProcessingPolicy<unsigned long, IDimension>::processData(appData); break;
          }

        case ::itk::ImageIOBase::LONG:
          {
            TProcessingPolicy<long, IDimension>::processData(appData); break;
          }

        case ::itk::ImageIOBase::FLOAT:
          {
            TProcessingPolicy<float, IDimension>::processData(appData); break;
          }

        case ::itk::ImageIOBase::DOUBLE:
          {
            TProcessingPolicy<double, IDimension>::processData(appData); break;
          }
      ...
      public:
        ...
        * @pre pImage must point to a valid instance.*/
          ...
          const map::core::String& uidPrefix, const ApplicationData& appData)
        {
          if (!pImage)
          {
            mapDefaultExceptionStaticMacro(<< "Cannot generate slice dictionaries. Passed image pointer is invalid (NULL).");
          }
